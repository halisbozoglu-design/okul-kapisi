...
export const PERMISSIONS = {
  ACCESS_MANAGE: { resource: 'access', action: 'manage' },
...
export const LEGACY_ROLE_PERMISSIONS: Partial<Record<AppRole, readonly PermissionKey[]>> = {
  super_admin: ['access:manage', 'settings:manage', 'transport:view', 'transport:manage', 'transport:live_track', 'transport.parent:view'],
  kurum_yoneticisi: ['access:manage', 'settings:manage', 'transport:view', 'transport:manage', 'transport:live_track'],
  okul_yoneticisi: ['access:manage', 'settings:manage', 'transport:view', 'transport:manage', 'transport:live_track'],
